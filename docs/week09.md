...
This week we move from automated text analysis to **hands-on coding of fan mail as a form of interpretation**. Using the _Amazing Spider-Man_ fan mail corpus (“The Spider’s Web”), you will apply a shared coding scheme to a set of letters and explore how qualitative coding transforms text into structured data.
